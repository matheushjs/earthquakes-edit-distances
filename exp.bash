...
for reg in ja nz gr jma; do
    for tlambda in 120 100 80 60 40 20 10 5 1 0.75 0.5 0.25 0.1 0.05; do
        python3 -u edit_distance_calc.py --region $reg --tlambda $tlambda --nthreads 24 --partial --partial_n 500 --outdir /media/mathjs/HD-ADU3/ --dry-run || true;
    done
done
...
for reg in ja nz gr jma; do
    for inputw in 3 2; do
        python3 -u edit_distance_calc.py --region $reg --tlambda 20 --inputw $inputw --nthreads 24 --partial --partial_n 500 --outdir /media/mathjs/HD-ADU3/ --dry-run || true;
    done
done
